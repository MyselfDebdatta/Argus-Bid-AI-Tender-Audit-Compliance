...
| **AI & NLP** | LangChain, Ollama, Groq, ChromaDB | Intelligent local/cloud hybrid semantic document classification, multi-vector search, and executive summarization using the `llama-3.3-70b-versatile` model. |
